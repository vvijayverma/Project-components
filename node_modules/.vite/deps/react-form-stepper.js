...
// node_modules/react-form-stepper/dist/react-form-stepper.esm.js
var import_react3 = __toESM(require_react());

// node_modules/react-form-stepper/node_modules/clsx/dist/clsx.m.js
function r(e) {
  var t, f, n = "";
...
function createThemeProvider(context) {
  var ThemeProvider2 = function(_React$Component) {
...
var shadeOrTintColor = function shadeOrTintColor2(colorString, ratio) {
  var color = (0, import_color.default)(colorString);
  return color.isDark() ? color.darken(ratio).hex() : color.lighten(ratio).hex();
};
var useStepStyles = createUseStyles({
  StepMain: {
    display: "flex",
...
var StepperContext = import_react3.default.createContext({
  activeStep: 0,
...
var useConnectorStyles = createUseStyles({
...
var convertNumericToPixel = function convertNumericToPixel2(object, property) {
  if (typeof object[property] === "number") {
    object[property] = object[property] + "px";
  }
};
var StepContext = import_react3.default.createContext({
  completed: false,
  active: false,
  disabled: false,
  index: 0
...
var Connector2 = function Connector3() {
  var _React$useContext = import_react3.default.useContext(StepperContext), connectorStateColors = _React$useContext.connectorStateColors, connectorStyleConfig = _React$useContext.connectorStyleConfig;
  var _React$useContext2 = import_react3.default.useContext(StepContext), completed = _React$useContext2.completed, active = _React$useContext2.active, stepSize = _React$useContext2.stepSize;
  var connectorStyle = _extends3({}, connectorStyleDefaults, connectorStyleConfig, {
  ...
  return import_react3.default.createElement("div", {
    ...
    id: "RFS-Connector",
    className: clsx_m_default(classes.Connector, {
...
var StepButton2 = function StepButton3(_ref) {
  var children = _ref.children, contentClasses = _ref.contentClasses, rest = _objectWithoutPropertiesLoose2(_ref, _excluded);
  var _React$useContext = import_react3.default.useContext(StepContext), completed = _React$useContext.completed, disabled = _React$useContext.disabled, index4 = _React$useContext.index;
  return import_react3.default.createElement("button", Object.assign({
    disabled
  }, rest), import_react3.default.createElement("span", {
    className: clsx_m_default(contentClasses, {
...
var useStepLabelStyles = createUseStyles({
...
var StepLabel = function StepLabel2(_ref) {
  var children = _ref.children, fontSize = _ref.fontSize, fontWeight = _ref.fontWeight;
...
var Step = function Step2(_ref) {
  var children = _ref.children, _ref$label = _ref.label, label = _ref$label === void 0 ? "" : _ref$label, styleConfig = _ref.styleConfig, completedProp = _ref.completed, activeProp = _ref.active, disabledProp = _ref.disabled, className = _ref.className, _ref$index = _ref.index, index4 = _ref$index === void 0 ? 0 : _ref$index, rest = _objectWithoutPropertiesLoose2(_ref, _excluded$1);
  var _React$useContext = (0, import_react3.useContext)(StepperContext), activeStep = _React$useContext.activeStep, hideConnectors = _React$useContext.hideConnectors, nonLinear = _React$useContext.nonLinear;
  var _activeProp = activeProp, active = _activeProp === void 0 ? false : _activeProp, _completedProp = completedProp, completed = _completedProp === void 0 ? false : _completedProp, _disabledProp = disabledProp, disabled = _disabledProp === void 0 ? false : _disabledProp;
  if (activeStep === index4) {
    active = activeProp !== void 0 ? activeProp : true;
  } else if (!nonLinear && activeStep > index4 && !activeProp && !disabledProp) {
    completed = completedProp !== void 0 ? completedProp : true;
  } else if (!nonLinear && activeStep < index4 && !activeProp && !completedProp) {
    disabled = disabledProp !== void 0 ? disabledProp : true;
  }
  var stepStyleProps = _extends3({}, styleConfig, {
    completed: completed && !disabled,
    active: active || !disabled
  });
  var classes = useStepStyles(_extends3({}, stepStyleDefaults, stepStyleProps.size && !stepStyleProps.circleFontSize && {
  ...
  return (0, import_react3.createElement)(StepContext.Provider, {
    value: contextValue
  }, index4 !== 0 && // If hideConnectors === 'inactive' render only active or completed connectors
  // If hideConnectors is something other than 'inactive' or true render all connectors
  (hideConnectors === "inactive" && (active || completed) || hideConnectors !== true && hideConnectors !== "inactive") && (0, import_react3.createElement)(Connector2, null), (0, import_react3.createElement)("div", {
    id: "RFS-StepMain",
    className: classes.StepMain
  }, (0, import_react3.createElement)(StepButton2, Object.assign({
    id: "RFS-StepButton",
    className: clsx_m_default(classes.StepButton, {
      active: !disabled && !completed
    }, {
      completed
    }, className),
    contentClasses: classes.StepButtonContent
  }, rest), children || index4 + 1), label && (0, import_react3.createElement)(StepLabel, {
...
var useStepperStyles = createUseStyles({
  StepperContainer: {
    display: "flex",
...
var Stepper = function Stepper2(_ref) {
  var steps = _ref.steps, children = _ref.children, _ref$connectorStateCo = _ref.connectorStateColors, connectorStateColors = _ref$connectorStateCo === void 0 ? false : _ref$connectorStateCo, _ref$className = _ref.className, className = _ref$className === void 0 ? "" : _ref$className, _ref$stepClassName = _ref.stepClassName, stepClassName = _ref$stepClassName === void 0 ? "" : _ref$stepClassName, _ref$activeStep = _ref.activeStep, activeStep = _ref$activeStep === void 0 ? 0 : _ref$activeStep, styleConfig = _ref.styleConfig, connectorStyleConfig = _ref.connectorStyleConfig, _ref$hideConnectors = _ref.hideConnectors, hideConnectors = _ref$hideConnectors === void 0 ? false : _ref$hideConnectors, _ref$nonLinear = _ref.nonLinear, nonLinear = _ref$nonLinear === void 0 ? false : _ref$nonLinear, rest = _objectWithoutPropertiesLoose2(_ref, _excluded$2);
  var classes = useStepperStyles();
  var contextValue = import_react3.default.useMemo(function() {
    return {
      activeStep,
      hideConnectors,
      nonLinear,
  ...
  var stepsArray = useStepsProp ? steps : import_react3.default.Children.toArray(children);
  var stepsToRender = stepsArray.map(function(step, index4) {
    if (!useStepsProp && !import_react3.default.isValidElement(step)) return null;
    var stepProps = {
    ...
    }, import_react3.default.isValidElement(step) ? import_react3.default.cloneElement(step, _extends3({}, stepProps, step.props)) : import_react3.default.createElement(Step, Object.assign({}, stepProps, typeof step === "object" ? step : {})));
  });
  return import_react3.default.createElement(StepperContext.Provider, {
    value: contextValue
  }, import_react3.default.createElement("div", Object.assign({
    id: "RFS-StepperContainer",
    className: clsx_m_default(classes.StepperContainer, className)
  }, rest), stepsToRender));
};
export {
  Step,
...
jss/dist/jss.esm.js:
   ...
   *)
*/
//# sourceMappingURL=react-form-stepper.js.map
